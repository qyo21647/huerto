...
st.markdown("<h1 style='text-align: center; color: blue; font-weight: bold; font-style: italic; font-family: Arial;'>Monitor de Mediciones</h1>", unsafe_allow_html=True)
